...
public class SwiftController {
    ...
    public ResponseEntity<CountrySwiftCodesDto> getAllSwiftsByCountry(@PathVariable @Size(min = 2, max = 2, message = "Country ISO2 code must contain 2 characters") String countryISO2) {
        CountrySwiftCodesDto swiftDtos = swiftService.getAllSwiftsByCountry(countryISO2);
    ...
    public ResponseEntity<MessageResponseDto> addNewSwiftCode(@RequestBody @Valid SwiftDto swiftDto) {
        ...
        return ResponseEntity.ok().body(new MessageResponseDto("Swift added successfully"));
    }
    ...
    public ResponseEntity<MessageResponseDto> deleteSwiftCode(@PathVariable @Size(min = 11, max = 11, message = "Swift code size must have 11 characters") String swiftCode) {
        ...
        return ResponseEntity.ok().body(new MessageResponseDto("Swift deleted successfully"));
    }
}
